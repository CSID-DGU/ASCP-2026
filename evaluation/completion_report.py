...
def build_completion_report(stage_results: Iterable[Dict], all_flight_ids: Iterable[int]) -> Dict:
    ...
    for stage in stages:
        compact_stages.append({
            ...
            "auto_operational": stage.get("auto_operational", False),
            "solve_reused": stage.get("solve_reused", False),
            "reused_from_stage": stage.get("reused_from_stage"),
